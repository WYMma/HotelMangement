...
@WebServlet("/agent/hotel/room-type/add")
public class AddRoomTypeServlet extends HttpServlet {
    private static final Logger logger = LoggerFactory.getLogger(AddRoomTypeServlet.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/jsp/agent/roomtype/add.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            logger.error("Database error while creating room type", e);
            request.setAttribute("error", "Error creating room type. Please try again.");
            request.getRequestDispatcher("/WEB-INF/jsp/agent/roomtype/add.jsp").forward(request, response);
        }
    }
}
